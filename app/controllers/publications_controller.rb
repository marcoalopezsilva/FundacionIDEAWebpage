class PublicationsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @publication.update(publication_params)
        format.html { redirect_to @publication, notice: 'La Publicación fue editada exitosamente.' }
  ...
  def destroy
    @publication.destroy
    respond_to do |format|
      format.html { redirect_to publications_url, notice: 'La Publicación fue eliminada.' }
